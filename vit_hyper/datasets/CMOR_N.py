...
"""
@File    : MNOR_C.py
@Description: CASIA,MSU, OULU, REPLAY ---> NUAA
...
def read_split_data(root: str, val_rate: float = 0.8):
    ...
    # for kkk in range(len(train_images_path)):
    #     print(train_images_path[kkk], train_images_label[kkk])
